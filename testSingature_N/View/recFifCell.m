...
//  BDAPP
//
//  Created by zhang bozhao on 2018/12/25.
//  Copyright © 2018年 zhang bozhao. All rights reserved.
//
...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        //        self.gifImg = [[YLImageView alloc]initWithFrame:CGRectMake(0, 0, ScreenWidth-40, 409)];
        //        self.gifImg.image = [YLGIFImage imageNamed:@"播放动态图标@3x.gif"];
        //        [self.bgview addSubview:self.gifImg];
