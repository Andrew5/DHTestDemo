...
/**
 *  dic 里内置的几个参数会用到上面定义的 string
 */
typedef void (^MGJRouterHandler)(NSDictionary *dic);

/**
 *  需要返回一个 object，配合 objectForURL: 使用
 */
typedef id (^MGJRouterObjectHandler)(NSDictionary *dic);
...
+ (nullable UIViewController *)getViewControllerWithStoryBoardName:(nonnull NSString *)StoryBoardName identifier:(nonnull NSString *)identifier;
